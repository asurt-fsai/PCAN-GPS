...
//------------------------------------------------------------------------------
//! void CAN_UserSendAliveMsg(void)
//------------------------------------------------------------------------------
//! @brief	Generates CAN message
//------------------------------------------------------------------------------
void CAN_UserSendAliveMsg() {
	CANMsg_t TxMsg;

	TxMsg.Id = 0xFF;
	TxMsg.Len = 8;
	TxMsg.Type = CAN_MSG_STANDARD;
	TxMsg.Data.Data8[0] = 0x11;
	TxMsg.Data.Data8[1] = 0x22;
	TxMsg.Data.Data8[2] = 0x33;
	TxMsg.Data.Data8[3] = 0x44;
	TxMsg.Data.Data8[4] = 0x55;
	TxMsg.Data.Data8[5] = 0x66;
	TxMsg.Data.Data8[6] = 0x77;
	TxMsg.Data.Data8[7] = 0x88;
	CAN_UserWrite(&TxMsg);
