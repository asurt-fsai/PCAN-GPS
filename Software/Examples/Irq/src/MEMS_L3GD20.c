...
HWStatus_t MEMS_L3GD20_init(void){
	...
	ConfRegs.Reg_0x20.bw = 1;
	ConfRegs.Reg_0x20.dr = 3;

	// set high pass filter mode to 0
...
//------------------------------------------------------------------------------
// void MEMS_L3GD20_ReadData(void)
//------------------------------------------------------------------------------
//! @brief	reads Data registers from gyroscope, converts the raw data and
//!			writes it into L3GD20_Readings structure
//------------------------------------------------------------------------------
void MEMS_L3GD20_ReadData(void){
